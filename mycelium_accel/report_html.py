...
caption{text-align:left;font-weight:bold;padding:.4rem 0;font-size:.9rem}
@media (prefers-color-scheme:dark){body{background:#121212;color:#e0e0e0}th{background:#2a2a2a}td,th{border-color:#555}.chart{background:#1a1a1a;border-color:#555}.win{background:#1d3a24}.meta,.note{color:#aaa}.flaky{color:#ffb74d;border-color:#ffb74d}}
@media print{body{max-width:100%;margin:0}.chart{break-inside:avoid}}
"""
...
<h2>Summary</h2>
<table><caption>Per-candidate summary</caption><tr><th scope="col">candidate</th><th scope="col">mean</th><th scope="col">stddev</th><th scope="col">median</th><th scope="col">min</th><th scope="col">max</th><th scope="col">runs</th></tr>
{"".join(rows_html)}</table>
<h2>Paired comparisons (per-seed deltas, BCa CI + corrected p)</h2>
<table><caption>Paired comparisons (per-seed deltas, BCa CI + corrected p)</caption><tr><th scope="col">candidate</th><th scope="col">mean Δ</th><th scope="col">CI low</th><th scope="col">CI high</th><th scope="col">p</th><th scope="col">p (corr)</th><th scope="col">dz</th></tr>
